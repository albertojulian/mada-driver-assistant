...
class TTS:
    def __init__(self):
        self.audio_speed = 1.75

    def text_to_speech(self, message, audio_speed=1.75, print_message=True, audio_file="tts_out.mp3"):
        ...
        try:
            ...
            self.audiofile_to_speech(audio_file, audio_speed)
            ...
            connection_error_audio_file = "gtts_connection_error.mp3"
            self.audiofile_to_speech(connection_error_audio_file, audio_speed)

    def audiofile_to_speech(self, audio_file, audio_speed=None):
